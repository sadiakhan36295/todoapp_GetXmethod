...
import 'package:practice_todoapp/view/controllers/my_profile_controller.dart'; // <- Make sure this is imported
...
class AppRoutes {
  ...
  static final routes = [
    ...
    // 🟢 Same controller used for edit screen
    GetPage(
      name: editProfile,
      page: () => EditProfileScreen(),
      binding: BindingsBuilder(() {
        Get.put(MyProfileController());
        Get.put(EditProfileController()); // Optional if needed separately
      }),
    ),
